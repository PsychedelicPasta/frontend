...
export default function WithdrawPopup() {
  ...
  <Container>
    ...
    <Popup
      trigger={<OpenButton>Withdraw</OpenButton>}
      modal
      nested
    >
      {close => (
        ...
        <br></br><br></br>
        <TextField id="outlined-basic" label="Deposit Amount" variant="outlined" defaultValue={"1,200.00"} helperText="Please select your Withdraw Amount" />
